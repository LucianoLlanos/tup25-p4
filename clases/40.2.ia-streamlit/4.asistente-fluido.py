...
def evaluar(mensajes, modelo, instrucciones, respuesta):
    ...
    parametros = {
        ...
        "input": mensajes,
        # Nota: eliminar herramientas integradas (web_search / code_interpreter)
        # porque localmente no están disponibles y producen errores 400
        # como "No tool output found for function call...".
        # Si quieres usar herramientas, definelas como funciones locales
        # siguiendo el patrón de `5.herramientas.py` / `7.herramientas.py`.
    }
