...
export default function MiniCart() {
  ...
  async function onVaciar() {
    ...
    try {
      ...
      toast.show('Error vaciando carrito: ' + (e?.message || e), 'error')
    }
  }

  const envio = 50 // si la API no lo devuelve, mostramos valor por defecto
  ...
  return (
    <div className="bg-white rounded-lg border p-4 space-y-4">
      ...
      {!loading && items.length === 0 && <p className="text-sm text-gray-600">Inicia sesión para ver y editar tu carrito.</p>}
