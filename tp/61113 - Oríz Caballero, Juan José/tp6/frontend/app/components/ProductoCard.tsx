  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-sky-700 mb-3 line-clamp-2">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleAdd}
            disabled={disabled}
            className={`px-4 py-2 rounded text-white ${disabled ? 'bg-gray-400 cursor-not-allowed' : 'bg-sky-600 hover:bg-sky-700'}`}
          >
